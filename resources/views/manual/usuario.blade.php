...
<ol>
    ...
    <ol>
        ...
        <p><h3>Editar Projeto:</h3> Faltou algum detalhe? Faça ajustes na página de apresentação do seu projeto, deixando o mesmo melhor apresentável para os visitantes da página do projeto.</p><br>

        <p><h3>Comentar nos Projetos:</h3> Interaja com outros alunos deixando comentários em projetos da comunidade, você pode ter pensando em algum detalhe que outras pessoas não viram. Lembre-se, respeite tanto o projeto quanto os alunos da página, exceder o limite será sujeito a punição.</p><br>
        ...
        <p><h3>Vincular Convites:</h3> Conecte seus projetos a convites e deixe que outros alunos vejam e se interessem a participar do seu Projeto. Alunos interessados em participar enviaram o e-mail pedindo a participação dele no seu projeto, verifique o seu e-mail para a montar a sua equipe.</p><br>


        <p><h3>Pedir Participação em Outros Projetos:</h3> Envie solicitações para participar de projetos de outros alunos enviando um e-mail para os responsáveis pelo projeto em questão e dividam experiências demonstrando suas habilidades de programador.</p><br>
    </ol>
</ol>
...
<ol>
    ...
    <ol>
        <p><h3>Visualização:</h3> Visualize seu perfil e informações pessoais. Aqui pode ser visualizado suas informações pessoais e profissionais por seus alunos e outros professores sobre você.</p><br>
        
        <p><h3>Editar Perfil:</h3> Atualize suas informações de perfil, incluindo --Campos do passo a passo--. deixe-o melhor apresentável aos visitantes ou deixe detalhes sobre você aqui para que lhe conheçam.</p><br>
    </ol>
