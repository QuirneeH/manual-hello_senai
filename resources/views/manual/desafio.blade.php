...
<h2>Criando um Projeto para Desafio (Aluno)</h2>
...
<ul>
    <li>Abra a pagina de Desafios e clique em um Desafio em específico que deseja participar</li><br>
    <li>Clique na opção –(nome da opção)-- para participar do desafio </li><br>
    <li>Estando escrito no Desafio o aluno poderá criar um Projeto para o Desafio semelhante a criação de um Projeto</li><br>
